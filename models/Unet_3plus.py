...
class UNet3Plus(nn.Module):
    def __init__(self, n_channels=3, n_classes=1, bilinear=True, feature_scale=4,
                 is_deconv=True, is_batchnorm=True, filters=[64, 128, 256, 512, 1024]):
...
#         decoder_4=self.decoder(torch.concat([decoder_4_decoder_5,decoder_4_encoder_4,decoder_4_encoder_3,decoder_4_encoder_2,decoder_4_encoder_1],axis=1))
...
#         decoder_3=self.decoder(torch.concat([decoder_3_decoder_5,decoder_3_decoder_4,decoder_3_encoder_3,decoder_3_encoder_2,decoder_3_encoder_1],axis=1))
...
#         decoder_2=self.decoder(torch.concat([decoder_2_decoder_5,decoder_2_decoder_4,decoder_2_decoder_3,decoder_2_encoder_2,decoder_2_encoder_1],axis=1))
...
#         decoder_1=self.decoder(torch.concat([decoder_1_decoder_5,decoder_1_decoder_4,decoder_1_decoder_3,decoder_1_decoder_2,decoder_1_encoder_1],axis=1))
...
#     return param_count
# print("Total params: %.2fM" % (count_param(model)/1e6))
# fps(model)